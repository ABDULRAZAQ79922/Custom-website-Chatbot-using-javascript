const userMessage = [
  ...
  const botReply = [
    ...
    ["Take some rest, Dude!"],
    ["i am friend of abdul"],
    ["My Work is to Guide the Student about their carrer and show them the roadmap for future"],
  ];
...
chatbotToggler.addEventListener("click", () => document.body.classList.toggle("show-chatbot"));
  ...
  function containMessageCheck(string) {
    ...
    let expectedMessage = [
      ...
      ["noon","afternoon","good afternoon"],
      ["what is time","time","tell me time", "today date","today date and time","tell me today's date","today's date"],
    ];
    let item;
  ...
  function addChat(input, product) {
    ...
    botDiv.innerHTML = `<img src="bot-image.jpg" alt="" class="bot-img">  <span id="bot-response">${product}</span>`;
